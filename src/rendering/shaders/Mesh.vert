...
// Transformation from World to 3D Image texture coordinates
uniform mat4 imageTexCoords_O_world;

// Transformation from World to 3D Parcellation texture coordinates
uniform mat4 labelTexCoords_O_world;
...
void main()
{
    ...
    vs_out.ImageTexCoords3D = vec3( imageTexCoords_O_world * worldPos );
    vs_out.LabelTexCoords3D = vec3( labelTexCoords_O_world * worldPos );
